    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <div class="container">
                ...
                $rus = "SELECT First_name, Course, Department, Complain, Response FROM student_response WHERE First_name='$name'";
                $sur = $conn->Query($rus);

                echo "<table class='table table-bordered' cellspacing='15px' border='0px' style='width:980px;height:auto;'>
    <thead> 
    <tr class='info'><th>Course</th><th>Department</th><th>Complain</th><th>Response</th></tr></thead>";

                while($row =mysqli_fetch_assoc($sur)) {

                    echo "<tr><td>".$row["Course"]."</td><td>".$row["Department"]."</td><td>".$row["Complain"]."</td><td>".$row["Response"]."</td></tr>";
