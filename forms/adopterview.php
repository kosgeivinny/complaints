...
$adm_no=$_REQUEST['adm_no'];
    ...
    $rus = "SELECT Firstname,Lastname,Gender,ID,Phone,Email,Country,Address,Occupation FROM confirmedadopted WHERE Admission_number='$adm_no'";
    $sur = $conn->Query($rus);
    ...
    while($row =mysqli_fetch_assoc($sur)) {
        ...
        echo "<tr class='info'><td>". $row["Firstname"] . " ". $row["Lastname"]."</td><td>".$row["Gender"]."</td><td>".$row["ID"]."</td><td>".$row["Phone"]."</td><td>".$row["Email"]."</td><td>".$row["Country"]."</td><td>".$row["Address"]."</td><td>".$row["Occupation"]."</td></tr>";
