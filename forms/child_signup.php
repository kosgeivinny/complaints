...
<body>
   ...
   <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2 align="center">ADD A CHILD TO THE SYSTEM HERE! </h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
  ...
  <div class="row">
    <form class="inline"id="form_staff" role="form" action="child_connect.php" method="POST" enctype="multipart/form-data">
      <legend>  <a href="stafff.php" class="btn btn-danger right" role="button" Valign="right"><span class="glyphicon glyphicon-off"></span> close </a> </legend>
      <div class="col-sm-12">
              <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 form-group">
            <label> Adm no: </label>
            <input type="int" class="form-control" name="admno" placeholder="Admission number">
          </div>
        ...
        <div class="col-sm-2 form-group">
          ...
          <button type="submit" class="btn btn-success" name="submit" ><span class="glyphicon glyphicon-plus-sign"></span> Add </button>
        </div>
        <div class="col-sm-2 form-group">
