...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            $name=$_REQUEST['name'];
            $sql= "SELECT * FROM staff_complain WHERE First_name = '$name'";
            ...
            <div class="container">
                ...
                <div class="col-lg-8 well">
                    <div class="row">
                        <form class="inline"id="form_staff" role="form" action="staffresponse_connect.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <input type="text"class="form-control" name="job" placeholder="Job Title" value="<?php echo $job ?>">
                                    </div>
