...
include ('../connect/connect.php');
	$adm_no=$_REQUEST['adm_no'];
    	$sql= "SELECT * FROM child WHERE child.Admission_number = '$adm_no'";
    ...
    $adm_no=$_REQUEST['adm_no'];
    $spl="SELECT * FROM confirmedspo WHERE confirmedspo.Admission_number='$adm_no'";
...
echo "";
    ...
    if (($adm_no)>=($aid)) {
            ...
            ?>
        <script> alert ('Sorry the Child is already in Sponsorship Select another please!');
        window.location.assign('sponsor.php');
        </script>
        <?php
        }
    }
...
<div class="container">
	...
	<div class="row">
		<form class="inline" role="form" action="sponsor_connect.php" method="POST">
			<legend> <b> Register here!</b> <a href="../forms/sponsor.php" class="btn btn-danger right" role="button" valign="right"><span class="glyphicon glyphicon-off"></span> close </a> </legend>
			<div class="col-sm-12">
            	<div class="row">
				...
				<div class="row">
					...
					<div class="col-sm-8 form-group">
						<label> <h4><b>Sponsor's Details</b></h4> </label>
			...
			<div class="row">
                        ...
                        <div class="row">                    
                            <div class="col-sm-6 form-group">
                                <label> Duration of sponsorship: </label>
                                <input type="text" class="form-control" name="duration" placeholder="Duration eg.how many years?">
                            </div>
