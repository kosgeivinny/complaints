    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="studentview.php"><i class="fa fa-qrcode "></i> Pending Complains </a>
                </li>
                <li>
        ...
        <div id="page-inner">
            ...
            <div class="container">
                ...
                <div class="col-lg-8 well">
                    <div class="row">
                        <form class="inline"id="form_staff" role="form" action="complain_connect.php" method="POST" enctype="multipart/form-data">
                            <legend>  <a href="student.php" class="btn btn-danger right" role="button" Valign="right"><span class="glyphicon glyphicon-off"></span> close </a> </legend>
                            <div class="col-sm-12">
                                <div class="row">
