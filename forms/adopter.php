        ...
        <div class="wrapper">
            ...
            <div class="well well-lg">
              ...
              <div class="panel-body" style="background: none;">
                <center><form action="sponsor.php" method="post">
                  <input type="button" class="btn btn-success btn-lg" value="Adopt" onclick="window.location.href='adopt.php'"><br><br>
                  <input type="submit" class="btn btn-info btn-lg"  value="Sponsor" onclick="window.location.href='sponsor.php'"><br><br>
                </form></center>
