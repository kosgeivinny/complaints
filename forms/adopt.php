...
<head>
 ...
 <body>
    ...
    <div class="container">
        ...
        <div class="paragraph" style="text-align:center; background-color:pale;"><font size="" color="#3366ff"><strong><em>Select a child to adopt from the list provided below, <br> Then complete the form that follows to adopt!</em></strong></font></div>
<?php
...
include "../connect/connect.php";
    ...
    <thead> 
    <tr style='background-color:purple;'><th>Profile Photo</th><th>First Name</th><th>Last Name</th><th>Home_ID</th><th>Admission Number</th><th>Description</th><th></th></tr></thead>";
    ...
    while($row =mysqli_fetch_assoc($sur)) {
        ...
        echo "<td><a href='adoptf.php? adm_no=".$row['Admission_number']."'>
        <button class=\"btn btn-warning btn-xs\"><span class=\"glyphicon glyphicon-delete\">Adopt</span></button>
        </a>
       </td></tr>";
    }
    echo "</table>";
