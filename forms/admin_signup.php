...
<div class="container">
    ...
    <ul>
        ...
        <li class="dropdown active "><a class="dropbtn"><span class="glyphicon glyphicon-user"></span> ADMIN </a>
            <div class="dropdown-content">
...
<br>
<div class="col-lg-8 well" style="background-color: palegreen;">
    <div class="row">
        <form class="inline"id="form_staff" role="form" action="admin_connect.php" method="POST" enctype="multipart/form-data">
            <legend> <h3  align="center"><i> Sign up here as an Admin! </i> </h3></legend>
            <div class="col-sm-12">
                <div class="row">
                ...
                <hr>
                <p>Already have an account? <a href="#aModal" data-toggle="modal" data-target="#aModal"> Sign in </a></p>
            </div>
        </form>
    </div>
</div>
