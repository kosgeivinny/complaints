...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li class="active-link">
                    <a href="solved_staff.php.php"><i class="fa fa-bar-chart-o"></i> Solved Staff Complains</a>
                </li>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h2 align="center"> SOLVED STAFF COMPLAINS </h2>
                </div>
            </div>
            <!-- /. ROW  -->
            <hr />
            <div class="container">
                ...
                $rus = "SELECT First_name, Job_title, Department, Complain, Response FROM staff_response";
                $sur = $conn->Query($rus);

                echo "<table class='table table-bordered' cellspacing='15px' border='0px' style='width:980px;height:auto;'>
    <thead> 
    <tr class='info'><th>Name</th><th>Job_title</th><th>Department</th><th>Complain</th><th>Response</th></tr></thead>";

                while($row =mysqli_fetch_assoc($sur)) {

                    echo "<tr><td>".$row["First_name"]."</td><td>".$row["Job_title"]."</td><td>".$row["Department"]."</td><td>".$row["Complain"]."</td><td>".$row["Response"]."</td></tr>";
